<template>
  <vs-card>
    <div slot="header"><h4>Latency of LDSF</h4></div>
    Deadline Satisfication Ratio: {{dsr.toFixed(3)}}
...
export default {
  ...
  methods: {
    draw() {
      ...
      // window.console.log("LDSF", "N",this.history.dsr.length, "\n",
      //   "avg_uplink",average(this.history.latency).toFixed(3),"\n",
      //     "avg_e2e", average(this.history.rtt).toFixed(3), "\n",
      //     "avg_dsr", average(this.history.dsr).toFixed(3) )
      // window.console.log("LDSF:", "n",this.history.dsr.length, "latency",this.history.latency,"rtt", this.history.rtt, "dsr", this.history.dsr)
      window.console.log("LDSF:", "n",this.history.dsr.length, "rtt", this.history.rtt, "dsr", this.history.dsr)
    },
