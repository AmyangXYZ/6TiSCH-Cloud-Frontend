<template>
      ...
      <vs-card>
        <div slot="header" >
          <h4>LDSF | <span style="text-decoration:underline;cursor:pointer;" @click="handleSwitch">{{simOrReal}}</span>
...
import {init4,inter_partition_adjustment, intra_partition_adjustment,get_sch4,kick4,get_scheduler} from './schedule-dpa-sim.js'
