<template>
      ...
      <vs-card>
        <div slot="header" >
          <h4>1D Partition Scheduler w/o OCAP | <span style="text-decoration:underline;cursor:pointer;" @click="handleSwitch">{{simOrReal}}</span>
...
import {init4,inter_partition_adjustment, intra_partition_adjustment,kick2,get_sch4} from './schedule-dpa-sim.js'
